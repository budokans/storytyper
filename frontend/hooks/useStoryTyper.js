...
export default function useStoryTyper() {
  ...
  useEffect(() => {
    fetch(`https://storytyper.herokuapp.com:2094/data?batch=${batchRequest}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("https://storytyper.herokuapp.com:2094/count")
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    if (unreadStories.length === 5) {
      fetch(`hhttps://storytyper.herokuapp.com:2094/data?batch=${batchRequest}`)
        .then((res) => res.json())
        .then((data) => {
